...
export function RouterDemo(): VNode {
  const router = useRouter();

  if (!router) {
    return (
      <section className="rounded-2xl border border-slate-200/80 bg-white/90 p-8 shadow-lg dark:border-slate-600/80 dark:bg-slate-800/90 sm:p-10">
        <p className="text-slate-600 dark:text-slate-300">Router 未注入</p>
      </section>
    );
  }
